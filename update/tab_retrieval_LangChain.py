...
def MultiQuery(chunks, embeddings, llm):
  """
...
def tab_retrievers():
  ...
  llm_model = st.selectbox("Select the llm model: ", ["Llama3-70b-8192", "Llama-3.1-70b-Versatile", "Llama-3.2-90b-Text-Preview", "gpt-35-turbo-1106", "gpt-4o-mini-2024-07-18"], key = 'llm_langchain')
  ...
  if st.button("Run", key = "contexts_Lang"):
    ...
    for i in range(len(questions)):
      if retrieval_model in ["Similarity Search","MMR", "Hybrid Search"]:
        ...
        retriever = MultiQuery(chunks_gen, embeddings, k = k, llm = llm)
